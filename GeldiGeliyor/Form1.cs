...
namespace GeldiGeliyor
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            p1.Price = 10000;
            p1.Stock = 20;
            p1.Description = "cok pahali";
            p1.Category = c1;
            ProList.Add(p1);

            Product p2 = new Product();
            p2.ProductName = "ucuz iphone";
            p2.Price = 200;
            p2.Stock = 12;
            p2.Description = "her eve lazim";
            p2.Category = c1;
            ProList.Add(p2);
            ...
            p5.ProductName = "Harry potter felsefe tasi";
            p5.Price = 35;
            p5.Stock = 234;
            ...
            p6.ProductName = "seyahatname";
            p6.Stock = 12;
            p6.Price = 123;
            p6.Description = "evliya çelebi tarafından yazılduı";
            p6.Category = c3;
            ProList.Add(p6);
        ...
        private void btnSiparis_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("lutfen kargo veya urun seciniz");
            }
            else
            {
                Customer MyMusteri = new Customer();
                MyMusteri.FirstName = "Ozhan";
                MyMusteri.LastName = "gulal";

                Order ord = new Order();
                ord.OrderName = Guid.NewGuid().ToString();
        ...
        private void rdbShipper1_CheckedChanged(object sender, EventArgs e)
        {
